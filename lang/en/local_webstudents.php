...
/**
 * English strings for Webstudents
 *
...
$string['student_name'] = 'Student Username';
$string['students_created'] = 'Student accounts created successfully';
$string['studentscreationerror'] = 'Failed to create student accounts';
$string['welcomeuser'] = 'Welcome to your Moodle account';
